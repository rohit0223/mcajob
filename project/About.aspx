                                    ...
                                    <div class="col-lg-9 col-md-9">
                                        <div class="menu-wrapper">
                                            ...
                                            <div class="header-btn d-none f-right d-lg-block">
                                                ...
                                                <asp:LinkButton ID="btn1" runat="server" CssClass="btn head-btn1" CausesValidation="false" OnClick="btn1_Click" Text="Register" ></asp:LinkButton>
                                                <asp:LinkButton ID="btn2" runat="server" CssClass="btn head-btn2" CausesValidation="false" OnClick="btn2_Click" Text="Login"></asp:LinkButton>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- Mobile Menu -->

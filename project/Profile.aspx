...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <style>
        ...
        .img-square {
            ...
            border-radius: 8px; /* slight rounding, remove for perfect square */
            display: block;
            margin-left: auto;
            margin-right: auto;
            cursor: pointer;
...
<asp:Content ID="Content2" runat="server" ContentPlaceHolderID="ContentPlaceHolder2">
    ...
    <div class="container pt-5 pb-5">
        <div class="main-body">
            <!-- Note: OnItemCommand must match code-behind method name exactly.
                 OnItemDataBound sets client-side attributes so image opens file chooser -->
            <asp:DataList ID="dlprofile" Width="100%" runat="server"
                OnItemCommand="dlprofile_ItemCommand"
                OnItemDataBound="dlprofile_ItemDataBound">
                <ItemTemplate>

                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox ID="txtnm" runat="server" class="form-control valid" placeholder="Enter your name" required></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <%--<input class="form-control valid" name="email" id="email" type="email" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter email address'" placeholder="Email">--%>
                                    <asp:TextBox ID="txteml" class="form-control valid" runat="server" placeholder="Email" required></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-group">
                                    <%--<input class="form-control" name="subject" id="subject" type="text" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter Subject'" placeholder="Enter Subject">--%>
                                    <asp:TextBox ID="txtsub" class="form-control" placeholder="Enter Subject" runat="server" required></asp:TextBox>
                                </div>
                            </div>
                        </div>
                        <div class="form-group mt-3">
                            <%--<button type="submit" class="button button-contactForm boxed-btn">Send</button>--%>
                            <asp:Button ID="btbSend" class="button button-contactForm boxed-btn" runat="server" Text="Send" OnClick="btbSend_Click" />
                        </div>
                        <%--</form>--%>
                    </div>
                </div>
